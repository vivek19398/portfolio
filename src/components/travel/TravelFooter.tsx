...
export default function TravelFooter() {
  ...
  return (
    <footer className="relative border-t border-white/5 bg-charcoal/60 mt-20">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="text-center sm:text-left">
          <p className="font-display tracking-widest text-mist">
            TRAVEL GALAXY<span className="text-ember">.</span>
          </p>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-semibold border border-ember/40 text-ember bg-ember/5 hover:bg-ember/15 transition-all hover:scale-[1.04]"
